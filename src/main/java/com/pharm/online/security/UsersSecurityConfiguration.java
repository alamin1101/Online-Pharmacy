...
public class UsersSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                .antMatchers("/admin","/add-new-medicine","/medicine-storage","/medicine-category","/medicine-category-all","/update-medicine","/delete-medicine","/consumerslist","/medicine-order","/medicine-order-list","/medicine-order-delete")
                .access("hasRole('ROLE_ADMIN')")
                .antMatchers(  "/medicine-storage-all","/consumer")
